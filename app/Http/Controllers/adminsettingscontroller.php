...
class adminsettingscontroller extends Controller
{
    ...
    public function update(settings $id, Request $request)
    {
        ...
        $request->validate([
            'passdefaultsiswa' => ['required', 'string', 'min:8', 'regex:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/'],
            'passdefaultortu' => ['required', 'string', 'min:8', 'regex:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/'],
            'passdefaultpegawai' => ['required', 'string', 'min:8', 'regex:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/'],
        ], [
            'passdefaultsiswa.regex' => 'Password harus mengandung huruf besar, huruf kecil, dan angka',
            'passdefaultortu.regex' => 'Password harus mengandung huruf besar, huruf kecil, dan angka',
            'passdefaultpegawai.regex' => 'Password harus mengandung huruf besar, huruf kecil, dan angka',
        ]);
